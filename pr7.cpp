...
} *all_head = NULL, *vanilla_head = NULL, *butter_head = NULL,
  *union_head = NULL, *inters_head = NULL, *diff_head = NULL;
...
int main() {
  ...
  do {
    cout << "\n1. To enter data";
    cout << "\n2. To display the rollnos of students who like vanila or "
            "butterscotch";
    cout << "\n3. To display the rollnos of students who like only vanila";
    cout
        << "\n4. To display the rollnos of students who like only butterscotch";
    cout << "\n5. To display the rollnos of students who like both vanila and "
            "butterscotch ";
    cout << "\n6. To display the rollnos of students who neither like vanila "
            "nor butterscotch";
    cout << "\n7. Exit";
    cout << "\nEnter choice: ";
    cin >> choice;
